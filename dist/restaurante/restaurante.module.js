...
RestauranteModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([restaurante_entity_1.RestauranteEntity]),
        ...
        providers: [restaurante_service_1.RestauranteService, jwt_1.JwtService, usuario_service_1.UsuarioService],
